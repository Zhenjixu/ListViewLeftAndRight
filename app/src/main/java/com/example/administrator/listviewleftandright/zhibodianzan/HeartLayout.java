...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        LayoutInflater.from(context).inflate(R.layout.item_heart, this);
    ...
    //todo
    private static int[] drawableIds = new int[]{R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher};
